...
//return creates the user interface
    return (
        ...
        <View style = {styles.container}>
         ...
         <Image style={styles.image}        //This is the part to render the images, not rendering the second part?
            resizeMode="contain"
            source={{uri: image ? image : "https://cdn.pixabay.com/photo/2012/04/01/17/29/box-23649_960_720.png:"}}
            />
        <View style = {styles.card} />
        <Text style = {styles.title}>
            {name.length > 15 ? name.substring(0, 15-3) //Not sure at all what these 3 lines are doing
          + '...': name  
          }
